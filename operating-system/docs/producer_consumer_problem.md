...
![](/operating-system/_img/cond_relation.png)
...
- 두번째 for 문은 데이터 생산이 중단됨을 소비자에게 알리기 위한 for 문
...
![](/operating-system/_img/cond_relation_consumer_producer.png)
...
소비자는 데이터가 있을 경우에만 데이터에 접근하며 3개의 스레드가 예측할 수 없는 순서로 진행됨을 알 수 있다.
